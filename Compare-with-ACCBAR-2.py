...
df = df[["Study", "Accuracy", "Baseline", "ACCBAR (Delta)", "DSPI (Alpha)", "ACCBAR (Delta) Ranked", "DSPI (Alpha) Ranked"]]
...
plt.xlabel("Study")
plt.tight_layout()
#plt.title("Accuracy = Baseline + Delta")
plt.show()
...
df.plot(x="Study", y=["ACCBAR (Delta) Scaled", "DSPI (Alpha)"], kind="bar", rot=0, figsize = (12,6))
